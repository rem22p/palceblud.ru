            ...
            <div style={{ position: "relative", display: "flex", alignItems: "center", backgroundColor: "rgba(255,255,255,0.04)", borderRadius: "99px", padding: "5px", border: "1px solid rgba(255,255,255,0.06)", zIndex: 31 }}>
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "99px",
                  zIndex: 0,
                  transition: "left 0.4s cubic-bezier(0.4, 0, 0.2, 1), background-color 0.4s cubic-bezier(0.4, 0, 0.2, 1)"
                }}
              />
              {/* Кнопка ОБУЧЕНИЕ */}
              <button onClick={() => navigate("/learning")} style={{ position: "relative", zIndex: 1, flex: 1, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.80rem", letterSpacing: "0.05em", padding: "8px 12px", borderRadius: "99px", border: "none", cursor: "pointer", backgroundColor: "transparent", color: displayMode === "learning" ? "#111" : "rgba(224,224,224,0.35)", fontWeight: displayMode === "learning" ? 700 : 400, transition: "color 0.4s cubic-bezier(0.4, 0, 0.2, 1)", whiteSpace: "nowrap" }}>обучение</button>
              {/* Кнопка ПОДГОТОВКА */}
              <button onClick={() => navigate("/prep")} style={{ position: "relative", zIndex: 1, flex: 1, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.80rem", letterSpacing: "0.05em", padding: "8px 12px", borderRadius: "99px", border: "none", cursor: "pointer", backgroundColor: "transparent", color: displayMode === "prep" ? "#111" : "rgba(224,224,224,0.35)", fontWeight: displayMode === "prep" ? 700 : 400, transition: "color 0.4s cubic-bezier(0.4, 0, 0.2, 1)", whiteSpace: "nowrap" }}>подготовка</button>
              {/* Кнопка ПРАКТИКА */}
              <button onClick={() => navigate("/practice")} style={{ position: "relative", zIndex: 1, flex: 1, fontFamily: "'JetBrains Mono', monospace", fontSize: "0.80rem", letterSpacing: "0.05em", padding: "8px 12px", borderRadius: "99px", border: "none", cursor: "pointer", backgroundColor: "transparent", color: displayMode === "practice" ? "#111" : "rgba(224,224,224,0.35)", fontWeight: displayMode === "practice" ? 700 : 400, transition: "color 0.4s cubic-bezier(0.4, 0, 0.2, 1)", whiteSpace: "nowrap" }}>практика</button>
            </div>
