// 2000 most common English words for typing practice

export const ENGLISH_WORDS = [
  // Most common words (1-100)
  ...
  "food", "eat", "drink", "bread", "milk", "coffee", "tea", "sugar", "salt", "house",
  "home", "room", "kitchen", "bedroom", "bathroom", "door", "window", "wall", "floor",
  ...
  "bound", "secured", "anchored", "moored", "docked", "berth", "parked", "stationed", "positioned", "placed",
  "located", "situated", "based", "founded", "established", "instituted", "organized", "formed", "created", "made",
  "built", "constructed", "erected", "raised", "assembled", "manufactured", "produced", "generated", "developed", "designed",
  "planned", "schemed", "plotted", "mapped", "charted", "graphed", "diagrammed", "sketched", "drew", "painted",
  "colored", "shaded", "tinted", "dyed", "stained", "bleached", "whitened", "blackened", "darkened", "lightened",
  "brightened", "enhanced", "improved", "bettered", "upgraded", "advanced", "progressed", "developed", "evolved", "grew",
  "expanded", "increased", "multiplied", "doubled", "tripled", "quadrupled", "quintupled", "sextupled", "septupled", "octupled",
  "nonupled", "decupled", "centupled", "millupled", "maximized", "optimized", "perfected", "refined", "polished", "finished",
  "completed", "concluded", "ended", "terminated", "stopped", "ceased", "halted", "paused", "rested", "relaxed",
  "calmed", "soothed", "comforted", "consoled", "reassured", "encouraged", "supported", "helped", "assisted", "aided",
  "served", "attended", "waited", "cared", "nursed", "tended", "looked", "watched", "observed", "viewed",
  "saw", "looked", "gazed", "stared", "glanced", "peeked", "peered", "squinted", "blinked", "winked",
  "closed", "opened", "widened", "narrowed", "expanded", "contracted", "compressed", "expanded", "inflated", "deflated",
  "punctured", "pierced", "penetrated", "entered", "invaded", "infiltrated", "permeated", "saturated", "soaked", "drenched",
  "dampened", "moistened", "wetted", "dried", "dehydrated", "desiccated", "parched", "scorched", "burned", "charred",
  "singed", "toasted", "roasted", "baked", "broiled", "grilled", "fried", "sauteed", "steamed", "boiled",
  "poached", "simmered", "stewed", "braised", "casserole", "roasted", "baked", "grilled", "barbecued", "smoked",
  "cured", "pickled", "preserved", "canned", "bottled", "jarred", "packaged", "wrapped", "boxed", "bagged",
  "sacked", "crated", "barreled", "drummed", "tanked", "vatted", "tubbed", "bucketed", "pailed", "pitchered",
  "jug", "flasked", "vialled", "ampuled", "syringed", "injected", "infused", "instilled", "dripped", "dropped",
  "splashed", "spilled", "poured", "streamed", "flowed", "rushed", "gushed", "spurted", "squirted", "sprayed",
  "misted", "fogged", "clouded", "hazed", "smoked", "steamed", "vaporized", "evaporated", "sublimed", "condensed",
  "precipitated", "crystallized", "solidified", "hardened", "stiffened", "rigidified", "firmed", "tightened", "loosened", "relaxed",
  "slackened", "eased", "softened", "gentled", "mellowed", "ripened", "matured", "aged", "weathered", "eroded",
  "corroded", "rusted", "tarnished", "oxidized", "reduced", "neutralized", "balanced", "equilibrated", "stabilized", "steady",
  "calmed", "quieted", "silenced", "hushed", "muted", "dampened", "deadened", "stifled", "suppressed", "repressed",
  "subdued", "overcome", "conquered", "defeated", "beat", "won", "triumphed", "prevailed", "succeeded", "achieved",
  "accomplished", "attained", "reached", "arrived", "came", "went", "left", "departed", "exited", "entered",
  "joined", "met", "greeted", "welcomed", "received", "accepted", "took", "got", "obtained", "acquired",
  "gained", "earned", "won", "deserved", "merited", "qualified", "entitled", "authorized", "permitted", "allowed",
  "let", "enabled", "empowered", "facilitated", "helped", "assisted", "supported", "backed", "endorsed", "approved",
  "sanctioned", "authorized", "licensed", "certified", "accredited", "validated", "verified", "confirmed", "substantiated", "corroborated",
  "authenticated", "validated", "legitimized", "legalized", "authorized", "sanctioned", "approved", "endorsed", "supported", "backed",
  "sponsored", "financed", "funded", "invested", "donated", "contributed", "gave", "offered", "provided", "supplied",
  "furnished", "equipped", "outfitted", "armed", "weaponed", "tool", "instrumented", "geared", "rigged", "set",
  "prepared", "ready", "primed", "loaded", "charged", "fueled", "powered", "energized", "activated", "triggered",
  "initiated", "started", "began", "commenced", "launched", "embarked", "undertook", "proceeded", "continued", "pursued",
  "followed", "chased", "pursued", "hunted", "tracked", "trailed", "shadowed", "stalked", "tracked", "traced",
  "followed", "accompanied", "escorted", "guided", "led", "directed", "conducted", "managed", "supervised", "oversaw",
  "controlled", "commanded", "ordered", "instructed", "taught", "educated", "trained", "coached", "mentored", "tutored",
  "schooled", "drilled", "practiced", "rehearsed", "exercised", "worked", "labored", "toiled", "slaved", "grinded",
  "slogged", "plugged", "pushed", "shoved", "pulled", "tugged", "yanked", "jerked", "snatched", "grabbed",
  "seized", "grasped", "gripped", "clutched", "held", "carried", "bore", "transported", "conveyed", "transmitted",
  "communicated", "conveyed", "expressed", "articulated", "enunciated", "pronounced", "uttered", "spoke", "talked", "conversed",
  "chatted", "gossiped", "gabbled", "jabbered", "prattled", "babbled", "blabbered", "chattered", "rattled", "clattered",
  "clanged", "clangor", "dinged", "donged", "ringed", "tolled", "pealed", "chimed", "tinkled", "jingled",
  "jangled", "jangled", "twanged", "pinged", "ponged", "boinged", "sprang", "leaped", "jumped", "hopped",
  "skipped", "bounded", "bounced", "rebounded", "ricocheted", "deflected", "reflected", "mirrored", "echoed", "reverberated",
  "resounded", "rang", "sounded", "noised", "roared", "bellowed", "yelled", "shouted", "screamed", "screeched",
  "shrieked", "yelped", "howled", "wailed", "moaned", "groaned", "sighed", "panted", "gasped", "huffed",
  "puffed", "blew", "exhaled", "inhaled", "breathed", "sniffed", "snuffed", "snorted", "sneezed", "coughed",
  "hack", "wheeze", "rasp", "gasp", "choke", "strangle", "suffocate", "smother", "asphyxiate", "drown",
  "sink", "plunge", "dive", "submerge", "immerse", "dip", "duck", "bob", "float", "drift",
  "sail", "cruise", "voyage", "journey", "travel", "tour", "trek", "hike", "march", "walk",
  "stride", "step", "pace", "tread", "tramp", "stomp", "stamp", "thump", "thud", "bang",
  "boom", "blast", "explode", "detonate", "ignite", "kindle", "light", "illuminate", "brighten", "glow",
  "shine", "gleam", "glisten", "glitter", "sparkle", "twinkle", "flicker", "flutter", "flap", "wave",
  "flail", "thrash", "lash", "whip", "crack", "snap", "pop", "burst", "break", "shatter",
  "smash", "crush", "squash", "squeeze", "press", "push", "shove", "nudge", "poke", "prod",
  "jab", "stab", "pierce", "penetrate", "enter", "invade", "infiltrate", "permeate", "saturate", "soak",
  "drench", "douse", "dunk", "dip", "immerse", "submerge", "plunge", "dive", "descend", "sink",
  "drop", "fall", "tumble", "topple", "overturn", "overturn", "capsize", "flip", "turn", "rotate",
  "spin", "whirl", "twirl", "swirl", "spiral", "coil", "curl", "twist", "writhe", "squirm",
  "wiggle", "waggle", "jiggle", "joggle", "wobble", "totter", "teeter", "stagger", "stumble", "trip",
  "slip", "slide", "skid", "glide", "coast", "drift", "float", "hover", "suspend", "hang",
  "dangle", "swing", "sway", "rock", "roll", "tumble", "somersault", "cartwheel", "handstand", "headstand",
  "balance", "poise", "steady", "stabilize", "secure", "fasten", "attach", "connect", "link", "join",
  "unite", "combine", "merge", "blend", "mix", "stir", "agitate", "shake", "vibrate", "oscillate",
  "pulsate", "throb", "beat", "pound", "hammer", "pound", "bash", "smash", "crash", "collide",
  "impact", "hit", "strike", "slap", "punch", "kick", "boot", "stamp", "stomp", "trample",
  "crush", "squash", "flatten", "level", "smooth", "even", "plane", "file", "sand", "polish",
  "buff", "shine", "gloss", "lacquer", "varnish", "paint", "coat", "cover", "wrap", "envelop",
  "encase", "enclose", "surround", "encircle", "ring", "gird", "belt", "band", "strap", "tie",
  "bind", "fasten", "secure", "anchor", "moor", "dock", "berth", "park", "station", "post",
  "place", "position", "locate", "situate", "set", "put", "lay", "rest", "repose", "lounge",
  "recline", "lean", "tilt", "slant", "slope", "incline", "decline", "descend", "ascend", "climb",
  "scale", "mount", "rise", "soar", "tower", "loom", "overshadow", "eclipse", "darken", "dim",
  "obscure", "hide", "conceal", "mask", "disguise", "camouflage", "cloak", "shroud", "veil", "cover",
  "blanket", "smother", "stifle", "choke", "strangle", "throttle", "garrote", "strangulate", "suffocate", "asphyxiate",
  "smother", "stifle", "suppress", "repress", "subdue", "overcome", "conquer", "defeat", "beat", "vanquish",
  "rout", "routing", "routed", "routs", "routing", "routed", "route", "router", "routes", "routing",
  "rout", "routs", "routed", "routing", "route", "router", "routes", "routing", "rout", "routs",
  "routed", "routing", "route", "router", "routes", "routing", "rout", "routs", "routed", "routing", "route",
];
